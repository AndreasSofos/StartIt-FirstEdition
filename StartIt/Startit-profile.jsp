...
<body>
    ...
    if(socials[3] != null){
			LinkedIn = socials[3];
                  ...
                  <a href="<%=LinkedIn%>"> <img src="images/linkedin-icon-color.png" alt=""> </a>
                  <a href="<%=Instagram%>"> <img src="images/instagram-icon-color.png" alt=""> </a>
                  <a href="<%=Twiter%>"> <img src="images/twitter-icon-color.png" alt=""> </a>                  
                </div>
              </div>  
