...
<%
   ...
   File file;
   int maxFileSize = 7000 * 5000;
   int maxMemSize = 7000 * 5000;
   ServletContext context = pageContext.getServletContext();
   String filePath = "C:\\Program Files\\Apache Software Foundation\\Tomcat 6.0\\webapps\\ismgroup79\\StartIt\\Uploads\\";
